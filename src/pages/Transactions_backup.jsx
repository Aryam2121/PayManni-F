  ...
  const getDemoTransactions = () => [
    {
      ...
      category: "transfer",
      icon: "user",
      details: { type: "debit", description: "Payment to John Doe", date: new Date().toISOString() },
    },
    {
      _id: "2",
      type: "received",
      ...
      category: "transfer",
      icon: "user",
      details: { type: "credit", description: "Payment from Sarah Wilson", date: new Date(Date.now() - 3600000).toISOString() },
    },
    {
      _id: "3",
      type: "bill",
      ...
      category: "bill",
      icon: "bolt",
      details: { type: "debit", description: "Electricity Bill Payment", date: new Date(Date.now() - 7200000).toISOString() },
    },
    {
      _id: "4",
      type: "recharge",
      ...
      category: "recharge",
      icon: "phone",
      details: { type: "debit", description: "Mobile Recharge", date: new Date(Date.now() - 86400000).toISOString() },
    },
  ];
