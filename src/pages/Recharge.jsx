...
const Recharge = () => {
  ...
  useEffect(() => {
    ...
    const fetchTransactionHistory = async () => {
      try {
        const response = await axios.get(`https://${import.meta.env.VITE_BACKEND}/api/recharge/${userId}/transactions`);
  ...
  const handleRecharge = async () => {
    ...
    try {
      const response = await axios.post(`https://${import.meta.env.VITE_BACKEND}/api/recharge`, {
        userId,
        amount: finalAmount,
        paymentMethod,
        promoCode,
