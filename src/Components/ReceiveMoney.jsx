  ...
  return (
    <div className="bg-white/70 backdrop-blur-lg border border-gray-200 shadow-xl rounded-2xl p-6 w-full max-w-md mx-auto hover:shadow-2xl transition-all duration-300">
      <div className="flex items-center gap-2 mb-5">
        ...
        <h2 className="text-2xl font-bold text-gray-800">Receive / Top-up</h2>
      </div>
      ...
      <form onSubmit={handleReceive} className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2 rounded-lg border focus:ring-2 focus:ring-yellow-500 focus:outline-none"
          />
        </div>
